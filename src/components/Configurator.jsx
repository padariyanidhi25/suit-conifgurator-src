...
const Configurator = () => {
  ...
  function hideElements() {
    const elementIds = [
      'monograminitials', 'monogram-option', 'lapelContent', 'lapel-option', 'lapel-width',
      'shoulder-option', 'confirmshoulder', 'confirmmonogram', 'canvas-option', 'confirmcanvas',
      'closure-option', 'confirmclosure', 'amf-option', 'confirmamf', 'collar-option',
      'confirmcolar', 'waistbandheigth-option', 'suspenderbutton-option', 'pocketcontentt',
      'pockett-option', 'pleat-option', 'confirmpleat', 'hemfinishing-option', 'confirmhemfinishing',
      'button-menut', 'confirmbuttont', 'leglinig-option', 'confirmleglinig', 'confirmsuspenderbtn',
      'confirmwaistbandheight', 'waistband-option', 'confirmwaistband', 'waistbandcontent',
      'waistcoatoption', 'waist', 'confirmlapel', 'confirmpockett'
    ];
  ...
  const selectyourtrousersize = document.getElementById('selectyourtrousersize')
  ...
  document.getElementById('confrmhemfinishing').addEventListener('click', () => {
    document.getElementById('hemfinishing-option').style.display = 'none'
    document.getElementById('confirmhemfinishing').style.display = 'none'
    trousr.style.display = 'flex'
  ...
  document.getElementById('confrmwaistbandheight').addEventListener('click', () => {
    document.getElementById('waistbandheigth-option').style.display = 'none'
    document.getElementById('confirmwaistbandheight').style.display = 'none'
    trousr.style.display = 'flex'
  })
  ...
  document.getElementById('confrmsuspenderbtn').addEventListener('click', () => {
    document.getElementById('suspenderbutton-option').style.display = 'none'
    document.getElementById('confirmsuspenderbtn').style.display = 'none'
    trousr.style.display = 'flex'
  })
  ...
  document.getElementById('backstyle-waistcoat').addEventListener('click', () => {
  ...
  document.getElementById('linigcolor-waistcoat').addEventListener('click', () => {
  ...
  document.getElementById('Previousjsizec').addEventListener('click', function () {
  ...
  document.getElementById('Previoustsizec').addEventListener('click', function () {
  ...
  function convertToCentimeters(rows) {
    for (let i = 0; i < rows.length; i++) {
      const cells = rows[i].getElementsByTagName('td');
      for (let j = 1; j < cells.length; j++) {
        const originalValue = parseFloat(cells[j].getAttribute('data-original-value'));
