...
export function Peakdoublebreasted(props) {
  const { nodes, materials } = useGLTF(
    "./latest/jacket/Coat Noch & peak Revesion/Peak/breasted.glb"
  );
...
export function Peakdoublebtn(props) {
  const { nodes, materials } = useGLTF(
    "./latest/jacket/Coat Noch & peak Revesion/Peak/double.glb"
  );
...
export function Peaksinglebtn(props) {
  const { nodes, materials } = useGLTF(
    "./latest/jacket/Coat Noch & peak Revesion/Peak/single.glb"
  );
  const [textureURL, setTextureURL] = useState(null);
